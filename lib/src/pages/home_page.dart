...
import 'package:leo_web/src/pages/admin/admin_home.dart';
...
Widget emailTextField(){
  return TextFormField(
    ...
    decoration:const  InputDecoration(
      ...
      // ),
      prefixIcon: Icon(Icons.email,color: Color(0XFF055E98),),
...
Widget passwordTextField(){
  return TextFormField(
    ...
    decoration:const InputDecoration(
      ...
      //   borderRadius: BorderRadius.circular(10)  ,
      // ),
        prefixIcon: Icon(Icons.vpn_key,color: Color(0XFF055E98),),
        prefixIconColor: Color(0xff055E98),
        label: Text("Password"),
        labelStyle: TextStyle(
          color: Color(0XFF055E98)
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          height: 150,
                          child: Image.asset("assets/LEO Inspector Logo.png"),
                        ),
                      ),
